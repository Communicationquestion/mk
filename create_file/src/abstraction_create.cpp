...
abstraction_create::Abs_create::set_project_path(std::string _file) {
...
abstraction_create::Abs_create::set_module_Path(std::string _file_path) {
...
int abstraction_create::Abs_create::create_cmaketxt(std::string _cmakePath,
                                                    std::string _txt) {
  std::ofstream oFile;
  // 不存在则新建文件
