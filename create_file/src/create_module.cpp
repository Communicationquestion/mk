...
int CreateModule::Create_Module::creta_files(std::string _file_name)
{
	...
	set_module_cmake_txt(_file_name);
...
int CreateModule::Create_Module::set_module_cmake_txt(std::string _file_name)
{
	...
	std::string add_library = "add_library(" + str + " STATIC ${srcs})\n";
